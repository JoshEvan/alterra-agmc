...
import (
	...
	"github.com/JoshEvan/alterra-agmc-day4/lib/database"
...
func GetUserByID(c echo.Context) error {
	...
	if err := auth(c, uint(id)); err != nil {
		return c.JSON(http.StatusUnauthorized, response{Status: http.StatusText(http.StatusUnauthorized), Error: err.Error()})
	}
